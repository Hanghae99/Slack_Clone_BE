package com.example.springdocumentsocket.security.filter;

import com.example.springdocumentsocket.security.jwt.HeaderTokenExtractor;
import com.example.springdocumentsocket.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        System.out.println("JWTAuthFilter 의 tokenPayload  :  "+tokenPayload);
        JwtPreProcessingToken jwtToken = new JwtPreProcessingToken(
                extractor.extract(tokenPayload, request));
        System.out.println("JWTAuthFilter 의 jwtToken  :  "+jwtToken);
